            ...
            <div className='flex flex-col justify-around items-center bg-gray-200 mx-20 my-10'>
                ...
                <div className='m-10 '>
                    ...
                    <div className=' flex justify-center gap-10 border-b-2 border-gray-300 '>
                        <div className={`flex items-center justify-center gap-3 cursor-pointer border-b-4 ${activeTab === 'breakfast' ? 'border-orange-500' : 'border-transparent'}`}
                            onClick={() => handleTabClick('breakfast')}>
                            <img src={menuIcon.Breakfast.icon} alt={menuIcon.Breakfast.name} className='h-14 w-14' />
                            <div>
                                <p>Popular</p>
                                <p className='font-bold'>{menuIcon.Breakfast.name}</p>
                            </div>
                        </div>
                        <div className={`flex items-center justify-center gap-3 cursor-pointer border-b-4 ${activeTab === 'lunch' ? 'border-orange-500' : 'border-transparent'}`}
                            onClick={() => handleTabClick('lunch')}>
                            <img src={menuIcon.Lunch.icon} alt={menuIcon.Lunch.name} className='h-14 w-14' />
                            <div>
                                <p>Special</p>
                                <p className='font-bold'>{menuIcon.Lunch.name}</p>
                            </div>
                        </div>
                        <div className={`flex items-center justify-center gap-3 cursor-pointer border-b-4 ${activeTab === 'dinner' ? 'border-orange-500' : 'border-transparent'}`}
                            onClick={() => handleTabClick('dinner')}>
                            <img src={menuIcon.Dinner.icon} alt={menuIcon.Dinner.name} className='h-14 w-14' />
                            <div>
                                <p>Lovely</p>
